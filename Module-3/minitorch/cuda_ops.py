...
def tensor_map(fn):
    ...
    def _map(out, out_shape, out_strides, out_size, in_storage, in_shape, in_strides):
        ...
        if i < out_size:
            ...
            out_data = in_storage[index_to_position(in_index, in_strides)]
            out[index_to_position(out_index, out_strides)] = fn(out_data)
...
def tensor_matrix_multiply(
    ...
    if i < out_size:
        ...
        a_index = cuda.local.array(MAX_DIMS, numba.int32)
        for pos in range(MAX_DIMS):
            a_index[pos] = out_index[pos]
