...
class Linear(minitorch.Module):
    ...
    def forward(self, inputs):
        ...
        # print(self.weights[0], '123')
        # print(self.weights[0][0], '123')
        # print(self.bias)
        # output = [len(inputs)] * len(self.bias)
        # print(np.shape(output))
        b = [bias.value for bias in self.bias]
        for index_1, input in enumerate(inputs):
            for index_2, bias in enumerate(self.bias):
                # y=xA^T +b
                b[index_2] = (input * self.weights[index_1][index_2].value) + b[index_2]
        # print(np.shape(b))
        return b
