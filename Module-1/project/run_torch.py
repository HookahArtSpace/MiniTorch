...
class Network(torch.nn.Module):
    def __init__(self, hiden_layer_size):
        ...
        # Submodules
        self.layer1 = Linear(2, hiden_layer_size)
        self.layer2 = Linear(hiden_layer_size, hiden_layer_size)
        self.layer3 = Linear(hiden_layer_size, 1)
...
class TorchTrain:
    def __init__(self, hiden_layer_size):
        ...
        self.model = Network(hiden_layer_size)
    ...
    def train(
        ...
        self.model = Network(self.hiden_layer_size)
