class Module:
    ...
    def named_parameters(self):
        ...
        def add_parameters(module, cur_name):
            """
            Add the name and :class:`Parameter` of each ancestor parameter to parameters_list
            """
            for key in module._parameters:
                parameter = module._parameters[key]
                parameters_list.append((cur_name + key, parameter))
            if module._modules:
                for name in module._modules:
                    add_parameters(module._modules[name], cur_name + name + ".")

        add_parameters(self, cur_name)
